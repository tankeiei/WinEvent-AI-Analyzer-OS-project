"""Parser module for turning Windows Event XML and raw data into CrashEvent models."""
...
def parse_event_xml(xml_str: str) -> Optional[CrashEvent]:
    ...
    Handles namespace variations and named or positional <Data> elements.
    """
    ...
    # Helper function to get named or positional value
    ...
    # Normalize exception code & look up meaning
